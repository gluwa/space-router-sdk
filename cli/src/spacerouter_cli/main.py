...
from spacerouter_cli.commands import api_key, billing, config_cmd, dashboard, node, regions, request, status
...
app.command(name="regions", help="List available proxy regions")(regions.regions)
